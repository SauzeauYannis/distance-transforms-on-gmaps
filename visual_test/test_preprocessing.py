...
from distance_transform.preprocessing import build_rgb_image_from_labeled_image, clean_borders, connected_component_labeling_one_pass, generalized_find_borders
...
class TestPreprocessing(TestCase):
    ...
    def test_clean_borders(self):
        image = cv2.imread(
            '../data/images/cleaned_borders_cross_section_leaf.png', 0)
        cleaned_image = clean_borders(image, 9)
        cv2.imwrite(
            'results/cleaned_borders_cross_section_leaf.png', cleaned_image)
